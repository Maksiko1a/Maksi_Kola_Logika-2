...
goal = 50  # стільки кораблів треба збити для перемоги
max_lost = 3  # максимально пропущених кораблів
...
while run:
    ...
    if not finish:
        ...
        # перевіряємо зіткнення куль з ворогами
        ...
        # перевіряємо, чи гравця вдарив ворог або він програв
